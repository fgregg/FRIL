...
public class ConverterColumnWrapper extends DataColumnDefinition {
	...
	public ConverterColumnWrapper(String name, int columnType, String sourceName) {
		super(name, columnType, sourceName);
	}
