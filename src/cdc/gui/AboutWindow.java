...
public class AboutWindow extends JDialog {
	...
	public AboutWindow() {
		...
		main.add(new JLabel("FRIL: Fine-Grained Record Integration and Linkage Tool"), new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 5));
