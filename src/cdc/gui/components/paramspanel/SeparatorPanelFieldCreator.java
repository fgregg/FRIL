...
public class SeparatorPanelFieldCreator implements FieldCreator {
	...
	public SeparatorPanelFieldCreator(String[] values, String[] labels, int x, int y) {
	...
	public SeparatorPanelFieldCreator(String[] values, String[] labels, int x, int y, boolean otherEnabled) {
		this.x = x;
		this.y = y;
		this.values = values;
		this.labels = labels;
	...
	public ParamPanelField create(JComponent parent, String param, String label, String defaultValue) {
		return new SeparatorPanelField(parent, param, label, defaultValue, values, labels, x, y, otherEnabled, listener);
	}
