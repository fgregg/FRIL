...
public class DedupeInfoPanel extends JPanel {
	
	private ProgressDialog parent;
	private JSlider slider = new JSlider(Thread.MIN_PRIORITY, Thread.MAX_PRIORITY);
	private JLabel duplicatesNumber = new JLabel("0");
	
	private int currX = 0;
	
	public DedupeInfoPanel(ProgressDialog parent) {
